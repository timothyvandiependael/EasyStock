...
namespace EasyStock.API.Migrations
{
    ...
    [Migration("20250710095801_AddedLineNumberToReceptionAndDispatch")]
    partial class AddedLineNumberToReceptionAndDispatch
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EasyStock.API.Models.Product", b =>
                {
                    ...
                    b.Property<int>("AutoRestockAmount")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("BackOrderedStock")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EasyStock.API.Models.DispatchLine", b =>
                {
                    ...
                    b.HasOne("EasyStock.API.Models.SalesOrderLine", "SalesOrderLine")
                        .WithMany("DispatchLines")
            ...
            modelBuilder.Entity("ProductSupplier", b =>
                {
                    b.HasOne("EasyStock.API.Models.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EasyStock.API.Models.Supplier", null)
                        .WithMany()
